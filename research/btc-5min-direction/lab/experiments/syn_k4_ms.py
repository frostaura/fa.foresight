"""syn_k4_ms — synthesis: multi-speed (shallow/logistic/full) ensemble at K=4.

Combines the two strongest ledger signals:
  * K=4 horizon (a3_k4_lgbm, 59.12% @cov2.5%, the horizon winner)
  * capacity-diverse ensemble (a3_mh_shlogfull_k3, 57.00% @cov2.5%)
Exact replication of a3_mh_shlogfull_k3's CapacityEnsemble with K=4 and the
internal embargo updated to EMB = K + 60 = 64 bars.
...
private isotonic calibration on the last 15% (embargoed EMB=64 bars); ensemble
