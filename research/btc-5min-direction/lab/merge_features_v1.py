#!/usr/bin/env python3
"""Merge the three family parquets onto the BTC 5m grid -> features_v1.pkl.
...
HOLDOUT_START_MS = 1780272000000  # 2026-06-01T00:00Z
...
def main():
    ...
    out_pkl = os.path.join(LAB, "features_v1.pkl")
    merged.to_pickle(out_pkl)
    with open(os.path.join(LAB, "features", "manifest.json"), "w") as f:
