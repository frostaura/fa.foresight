...
public sealed class Model
{
    ...
    /// <summary>
    /// AI-generated plain-English description (1–2 sentences) suitable for non-experts.
    /// Generated by <c>ModelDescriber</c> in a background continuation after create/update.
    /// Null until the first generation completes or when <c>OpenRouter:ApiKey</c> is absent.
    /// </summary>
    public string? SimpleDescription { get; set; }
    /// <summary>
    /// AI-generated technical description (2–3 sentences) for a data scientist — features,
    /// estimator, intervals, honest framing. Generated alongside <see cref="SimpleDescription"/>.
    /// </summary>
