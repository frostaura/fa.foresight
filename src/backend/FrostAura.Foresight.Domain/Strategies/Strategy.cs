...
public sealed class Strategy
{
    ...
    /// <summary>
    /// Plain-English description (1–2 sentences) for a non-expert. Generated deterministically by
    /// <c>DescriptionTemplater.ForStrategy</c> at create/update — no external LLM or API key.
    /// </summary>
    public string? SimpleDescription { get; set; }
    /// <summary>
    /// Technical description (2–3 sentences) for a quant — sizing inputs and risk framing.
    /// Generated alongside <see cref="SimpleDescription"/>.
    /// </summary>
