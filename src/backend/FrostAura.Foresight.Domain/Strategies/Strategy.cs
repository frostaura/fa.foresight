...
public sealed class Strategy
{
    ...
    /// <summary>
    /// AI-generated plain-English description (1–2 sentences) for a non-expert.
    /// Generated by <c>StrategyDescriber</c> in a background continuation after create/update.
    /// Null until the first generation completes or when <c>OpenRouter:ApiKey</c> is absent.
    /// </summary>
    public string? SimpleDescription { get; set; }
    /// <summary>
    /// AI-generated technical description (2–3 sentences) for a quant — sizing formula, edge
    /// assumptions, risk profile. Generated alongside <see cref="SimpleDescription"/>.
    /// </summary>
